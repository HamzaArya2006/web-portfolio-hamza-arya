        ...
        <div class="max-w-4xl mx-auto">
          ...
          <footer class="mt-16 pt-12 border-t border-white/10">
            <div class="flex flex-wrap gap-2 mb-6">
              ${post.tags.map(tag => `<a href="/blog?tag=${encodeURIComponent(tag)}" class="inline-flex items-center px-3 py-1 rounded-full bg-blue-500/10 text-blue-300 text-xs font-medium hover:bg-blue-500/20 transition-colors">#${tag}</a>`).join('\n              ')}
            </div>
            <div class="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
              <a href="/blog" class="btn-ghost inline-flex items-center">
    ...
    <article class="py-16 bg-black relative overflow-hidden">
      ...
      <div class="container-pro relative">
        <div class="max-w-5xl mx-auto">
          ...
          <footer class="mt-16 pt-12 border-t border-white/10">
            <div class="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
              <a href="/projects" class="btn-ghost inline-flex items-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" class="mr-2">
                  <path d="M19 12H5M12 19l-7-7 7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                Back to Portfolio
